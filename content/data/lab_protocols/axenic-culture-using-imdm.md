...
key: 626c52a3-3895-4593-9341-b4f7b8784817
...
- _If not included in IMDM powder_:
- l-Glutamine
...
1. To make 1 L of complete IMDM medium, add the following reagents and filter sterilize using a 0.22-µm-pore-size vacuum filter (do not autoclave IMDM):
...
Results and validation from this protocol can be found in Ho et al. ([1993](https://currentprotocols.onlinelibrary.wiley.com/doi/10.1002/cpz1.70175#cpz170175-bib-0012)).
