...
<h-hero>Markdown for BlastoDB</h-hero>

BlastoDB is build on Markdown, a simplified (or *marked down*) version of HTML (*H*yper*T*ext *M*arkup *L*anguage).

[:hero]

Look at the [markdown cheat sheet](/documentation/markdown/markdown_cheat_sheet/)



# What is Markdown? {#what_is_markdown}

Markdown is a simple markup language that can be used to add formatting elements to plain text.
