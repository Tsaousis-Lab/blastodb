...
[collector -> datasets; search:[title,subtypes]; sort:[publication_date,title]; filters:[Subtypes->[subtypes],Countries->[countries]]; arrange:rows; card-template:dataset-card.njk; clickable:false]
